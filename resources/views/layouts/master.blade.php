    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <a class="nav-link font-weight-bold">Mentoring kendaraan</a>
                </li>
            </ul>
            ...
            <div class="sidebar">
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview">
                        <li class="nav-item">
                            <a href="/FuelConsumption/index" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="/ServiceSchedule/index" class="nav-link">
                                <i class="nav-icon fas fa-layer-group"></i>
                                <p>
                                    ServiceSchedule
                                </p>
                        ...
                        <ul class="nav nav-treeview bg-light">
                            <li class="nav-item">
                                <a href="/vehicle/index" class="nav-link text-black">
                                    <i class="far fas fa-user nav-icon"></i>
                                    <p>vehicle</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="/VehicleBooking/index" class="nav-link text-black">
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview bg-light">
                            <li class="nav-item">
                                <a href="/ApprovalLevel/index" class="nav-link text-black">
                                    <i class="far fas fa-user nav-icon"></i>
                                    <p>ApprovalLevel</p>
                                </a>
                            </li>                            
                            <li class="nav-item">
                                <a href="/ApprovalHistory/index" class="nav-link text-black">
